...
public class AlexFrame{
	...
	private void toMakeFunctionPanel()
	{
		...
		this.cgJLabelImg(onLive, "pic/Icon/战旗.png", 40, 15);
		this.music = new JButton();
		this.cgJLabelImg(music, "pic/Icon/音乐.png", 100, 15);
		this.tieba = new JButton();
		this.cgJLabelImg(tieba, "pic/Icon/贴吧.png", 160, 15);
		this.weibo = new JButton();
		this.cgJLabelImg(weibo, "pic/Icon/微博.png", 220, 15);
